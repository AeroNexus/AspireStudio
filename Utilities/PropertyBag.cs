...
namespace Aspire.Utilities
{
	...
	public class PropertySpec
	{
		...
		public PropertySpec(string name, string type) : this(name, Type.GetType(type), null, null, null) { }
		...
		/// property grid.</param>
		public PropertySpec(string name, string type, string category) : this(name, Type.GetType(type), category, null, null) { }
		...
		public PropertySpec(string name, string type, string category, string description) :
			this(name, Type.GetType(type), category, description, null) { }
		...
		public PropertySpec(string name, string type, string category, string description, object defaultValue) :
			this(name, Type.GetType(type), category, description, defaultValue) { }
		...
		public PropertySpec(string name, string type, string category, string description, object defaultValue,
			string editor, string typeConverter) :
			this(name, Type.GetType(type), category, description, defaultValue, editor, typeConverter) { }
		...
		/// <summary>
		/// Gets the fully qualfied name of the type of this
		/// property.
		/// </summary>
		public string TypeName
		{
			get { return typeAsType.AssemblyQualifiedName; }
		}
		...
		public Type Type
		{
			get { return typeAsType; }
			set { typeAsType = value; }
		}
	}
	...
	public class PropertyBag : ICustomTypeDescriptor
	{
		...
		public class PropertySpecDescriptor : PropertyDescriptor
		{
			...
			/// <summary>
			/// Gets the <see cref="PropertySpec"/> representing the property
			/// </summary>
		...
		/// <summary>
		/// Gets or sets the Name for this collection. Used by <see cref="ToString"/>
		/// </summary>
		...
		/// <summary>
		/// Gets the properties in a <see cref="PropertyDescriptorCollection"/>
		/// </summary>
		...
		PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
		{
			...
			foreach (PropertySpec property in properties)
			{
				...
				if (property.ConverterTypeName != null && property.ConverterTypeName.Length != 0)
