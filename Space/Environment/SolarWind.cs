...
{
	public class SolarWind : EnvironmentModel
	{
		#region Declarations
		...
		/// 
		/// </summary>
		public class SolarWindContext : EnvironmentModelContext
		{
			/// <summary>
			/// default constructor
			/// </summary>
			public SolarWindContext() {}
			...
			public SolarWindContext(EnvironmentModel model, Model owner)
				: base(model, owner)
			{
			}
		...
		{
			return new SolarWindContext(this, owner);
		}
