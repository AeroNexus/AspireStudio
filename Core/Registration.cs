...
namespace Aspire.Core
{
	...
	public class Registration
	{
		...
		public Registration(string xtedsText, MessageHandler messageHandler, Uuid compId)
		{
			XtedsText = xtedsText;
		...
		public CoreAddressList GetRegistrars(IApplication application, DomainScope domainScope, string domainName)
		{
			...
			//do
			//{
			//	var registrars = mControlProtocol.AddressServer.GetAddresses("DIRECTORY", application.DomainName, scope);
				mRegistrars.Clear();
